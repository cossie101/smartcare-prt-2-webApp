...
<head>
    ...
    <link href="{{ asset('js/fa/all.min.js') }}" rel="stylesheet">
    <script type="text/javascript" src="{{ asset('js/jquery/jquery.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/jquery/jquery-ui.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('css/fa/js/all.js') }}"></script>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/fa/webfonts/fa-solid-900.woff') }}">
...
<body >
    <div id="app" >
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light " style="margin-left: 12%;">
            <div class="container">
        ...
        <main class="" style="margin-left: 12%;">
            @yield('content')
        </main>
    </div>
</body>
